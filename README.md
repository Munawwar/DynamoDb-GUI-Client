...
### [Release v3.4.2](https://github.com/Munawwar/DynamoDb-GUI-Client/releases/tag/v3.4.2)

#### [Download for MacOS (.dmg)](https://github.com/Munawwar/DynamoDb-GUI-Client/releases/download/v3.4.2/DynamoDbGUI-mac-3.4.2.dmg)

#### [Download for MacOS (.zip)](https://github.com/Munawwar/DynamoDb-GUI-Client/releases/download/v3.4.2/DynamoDbGUI-mac-3.4.2.zip)
